		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">Kullanıcı Kayıt Formu</div>
					...
					<form id="signup_form" onsubmit="return false">
						...
						<div class="row">
							<div class="col-md-12">
								<input style="width:100%;" value="Kaydol" type="submit" name="signup_button"class="btn btn-success btn-lg">
							</div>
						</div>
