			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<h1>Müşteri Sipariş Detayları</h1>
						<hr/>
						<?php
							include_once("db.php");
								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Ürün İsmi</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Ürün Fiyatı</td><td><b><?php echo "$ ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Adet</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>İşlem Id</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
