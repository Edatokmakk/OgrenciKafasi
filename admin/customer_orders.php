      ...
      <div class="modal-body">
        <form id="add-product-form" enctype="multipart/form-data">
        	<div class="row">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Ürün Anahtar Kelimeleri <small>(örn: web, donanım, yazılım)</small></label>
		        		<input type="text" name="product_keywords" class="form-control" placeholder="Ürün Anahtar Kelimeleri Giriniz">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
