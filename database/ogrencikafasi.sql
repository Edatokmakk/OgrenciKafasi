...
CREATE TABLE `admin` (
  ...
  `email` varchar(100) CHECK (email like '%_@__%.edu.tr%'),
...
(1, 'Eda', 'edatkmk@gmail.com', '$2y$10$Z1DnKbJRDFUTHMI7y1vSqeU3.Y9cgDyC4AeWx4.ucH34z/mkzL2E.', '0');
...
ALTER TABLE `admin`
  ...
  ADD CONSTRAINT chk_email CHECK (email like '%_@__%.edu.tr%');
