	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			...
			<ul class="nav navbar-nav navbar-right">
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-md-3">Ürün İsmi</div>
									<div class="col-md-3">$ ile öde.</div>
								</div>
							</div>
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>Oturum Aç</a>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<p><br/></p>
										<a href="#" style="color:white; list-style:none;">Şifreyi Unuttum</a><input type="submit" class="btn btn-success" style="float:right;">
									</form>
								</div>
		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<div id="get_product">
							<!--Burada ürün jquery Ajax Talebi -->
						</div>
